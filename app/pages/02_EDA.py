...
import os  # <--- Importante para resolver las rutas en la nube
...
# =========================
# CARGA DE DATOS (SOLUCIÓN AL ERROR)
# =========================
# Detecta dinámicamente la ubicación de este archivo (app/pages/02_EDA.py)
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))

# Sube un nivel para salir de 'pages' (u otra subcarpeta) y entra a 'data/processed/...'
DATA_PATH = os.path.normpath(os.path.join(CURRENT_DIR, "..", "data", "processed", "dataset_limpio.csv"))

# Intenta cargar el archivo de manera segura
try:
    df = pd.read_csv(DATA_PATH)
except FileNotFoundError:
    # Plan B: Si la estructura en la nube toma la raíz del repositorio directo como base
...
# Corrección limpia para rotar las etiquetas usando el contenedor 'ax'
